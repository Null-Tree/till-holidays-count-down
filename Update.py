...
def calc():
    ...
    total_sessions_of_misc_days = weekdays_misc * 4
    total_fullday_sessions = total_sessions_fulldays+total_sessions_of_misc_days
    ...
    fourth_session_time = datetime(today.year,today.month,today.day,1,50)
